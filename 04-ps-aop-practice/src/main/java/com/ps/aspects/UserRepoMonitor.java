...
public class UserRepoMonitor {
    ...
    @AfterReturning(value = "execution(* com.ps.services.*Service*+.update*(..))", returning = "result", argNames = "result")
    ...
    @AfterThrowing(value = "execution(* com.ps..*Service*.updateUsername(..))", throwing = "e", argNames = "e")
    ...
    @Around("execution(* com..*Repo*.find*(..))")
